The following details out how to implement your own ContextRunner to output log entries however you wish. If you're looking for information about ContextRunner in general, please click [here]().
